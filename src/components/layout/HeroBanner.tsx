  ...
  return (
    <section className="relative overflow-hidden pt-6 pb-10 sm:pt-10 sm:pb-14 border-b border-purple-500/15">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-3xl p-6 sm:p-10 lg:p-12 overflow-hidden metal-card">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              {/* Slogan Pill */}
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-purple-950/70 border border-purple-500/30 text-purple-300 text-xs font-semibold tracking-wider uppercase mb-4 shadow-[0_0_15px_rgba(168,85,247,0.2)]">
                <Sparkles className="w-3.5 h-3.5 text-purple-400 animate-pulse" />
                <span>Global Vision • Intelligent Finance • A Better Tomorrow</span>
              </div>

              {/* Title with Chrome Gradient */}
              <h1 className="text-3xl sm:text-5xl lg:text-5xl font-black tracking-tight leading-tight mb-4">
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 mb-6">
                <span className="text-xs text-slate-400 mr-1">快捷直达:</span>
                <button
                  onClick={() => onQuickJump('courseware')}
                  className="px-3 py-1 rounded-xl bg-purple-950/60 hover:bg-purple-900/60 border border-purple-500/30 text-xs text-purple-300 hover:text-white transition-all flex items-center gap-1 cursor-pointer"
                >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-xl">
                <div className="p-3 rounded-2xl bg-white/[0.04] border border-white/10 backdrop-blur-sm">
                  <div className="text-xl font-black font-['Space_Grotesk'] text-white">
                    {totalAssets}+
                  </div>
                  <div className="text-[11px] text-slate-400 mt-0.5">精选收录物料</div>
                </div>

                <div className="p-3 rounded-2xl bg-white/[0.04] border border-white/10 backdrop-blur-sm">
                  <div className="text-xl font-black font-['Space_Grotesk'] text-purple-300">
                    5 大专区
                  </div>
                  <div className="text-[11px] text-slate-400 mt-0.5">模块化精准归档</div>
                </div>
                ...
                <div className="p-3 rounded-2xl bg-white/[0.04] border border-white/10 backdrop-blur-sm">
                  ...
                  <div className="text-[11px] text-slate-400 mt-0.5">单卡多语即时切换</div>
                </div>
                ...
                <div className="p-3 rounded-2xl bg-white/[0.04] border border-white/10 backdrop-blur-sm">
                  ...
                  <div className="text-[11px] text-slate-400 mt-0.5">直开极速下载</div>
                </div>
              </div>

            </div>

            {/* Right Hero Showcase: 3D Chrome Logo Display */}
